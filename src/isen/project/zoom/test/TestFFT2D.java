...
public class TestFFT2D 
{
	public static void testFft2d()
	{
		...
		Complex[][] result = new Complex[][] {{new Complex(0, 0), new Complex(8, 0), new Complex(0, 0), new Complex(8, 0)}, 
	...
	{
		Complex[][] testSignal = new Complex[][] {{new Complex(0, 0), new Complex(0, 1), new Complex(0, 0), new Complex(0, -1)}, 
