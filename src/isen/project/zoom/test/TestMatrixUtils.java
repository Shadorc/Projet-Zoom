...
public class TestMatrixUtils
{
	...
	public static void testTranspose()
	{
		...
		{
			System.out.println("Test transpose : erreur");
		}
	...
	{
		Complex[] testArray = new Complex[] { new Complex(1, 1), new Complex(2, 2), new Complex(3, 3),
				new Complex(4, 4) };
		...
		{
			System.out.println("Test array equals : erreur");
		}
	}
	...
	public static void testMatrixEquals()
	{
		...
		{
			System.out.println("Test matrix equals : erreur");
		}
	}
